...
* item[0].item[0].item[0].answer.valueReference = Reference(CSC-SNF-CAM-Admission-1-Ob-Question-1)
...
* item[0].item[0].item[1].answer.valueReference = Reference(CSC-SNF-CAM-Admission-1-Ob-Question-3)
...
* item[0].item[0].item[2].answer.valueReference = Reference(CSC-SNF-CAM-Admission-1-Ob-Question-5)
